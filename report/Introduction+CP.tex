...
We use \texttt{Z3} via its Python API to solve the SAT encodings. Decision and optimization results (times and objectives) are those reported in our SAT study; tables and per-encoding comparisons are consistent with the standalone SAT write-up and are omitted here for brevity.
