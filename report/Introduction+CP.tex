...
The validation strategy follows a two-phase approach:

\begin{enumerate}
    \item \textbf{Phase 1: encoding selection (Vanilla).} We first performed a comparative analysis of four pure cardinality constraint encodings to identify the most robust baseline. The ``Vanilla'' solvers implement the standard constraints using \textit{Sequential Counter}, \textit{Totalizer}, \textit{Heule} and \textit{Pairwise}.
    % \begin{itemize}
    %     \item \textit{Sequential Counter}: Uses auxiliary variables to count literals ($O(n)$ clauses).
    %     \item \textit{Totalizer}: Uses a divide-and-conquer tree structure ($O(n \log n)$ clauses).
    %     \item \textit{Heule}: An efficient encoding optimized for ``exactly-one'' constraints.
    %     \item \textit{Pairwise}: Naive encoding with quadratic/cubic complexity but strong unit propagation ($O(n^2)$ or $O(n^3)$ clauses).
    % \end{itemize}

    \item \textbf{Phase 2: ablative analysis (Smart).} Using the most effective encoding logic derived from Phase 1 (implemented in the ``Smart'' baseline), we evaluated the impact of domain-specific optimizations through four configurations:
    \begin{itemize}
...
\midrule
12 & 1   & 1   & 0   & 0   & 0   & 0   & 0   & 0
   & 2\textbar\textbf{1}  & 1\textbar\textbf{1}  & 0\textbar\textbf{1}  & 1\textbar\textbf{1}  & 1\textbar\textbf{1}  & 1\textbar\textbf{1}  & 1\textbar\textbf{1}  & 1\textbar\textbf{1} \\
14 & 2   & 2   & 0   & 2   & 1   & 1   & 1   & 1
   & 3\textbar\textbf{1}  & 3\textbar\textbf{1}  & 4\textbar\textbf{1}  & 3\textbar\textbf{1}  & 5\textbar\textbf{1}  & 2\textbar\textbf{1}  & 4\textbar\textbf{1}  & 2\textbar\textbf{1} \\
16 & 9   & 5   & 4   & 8   & 10  & 10  & 19  & 10
   & 9\textbar\textbf{1}  & 17\textbar\textbf{1} & 2\textbar\textbf{1}  & 43\textbar\textbf{1} & 46\textbar\textbf{1} & 5\textbar\textbf{1}  & 68\textbar\textbf{1} & 6\textbar\textbf{1} \\
18 & 26  & 14  & 15  & 29  & 31  & 34  & 1   & 5
   & 45\textbar\textbf{1} & 187\textbar\textbf{1} & 73\textbar\textbf{1} & 223\textbar\textbf{1} & 121\textbar\textbf{1} & 23\textbar\textbf{1} & N/A                & 17\textbar\textbf{1} \\
20 & 48  & 272 & 94  & 230 & 73  & 104 & 169 & 42
   & N/A                 & 300\textbar{}10     & N/A                & N/A                & 300\textbar{}5      & 161\textbar\textbf{1} & N/A                & 111\textbar\textbf{1} \\
22 & N/A & N/A & N/A & N/A & N/A & 80  & N/A & N/A
   & N/A                 & N/A                 & N/A                & N/A                & N/A                & 300\textbar{}5      & N/A                & 195\textbar\textbf{1} \\
\bottomrule
\end{tabular}
}
\caption{Experimental results for SAT decisional and optimization models. Time in seconds.}
\label{tab:sat_results}
\end{table}
\section{SMT Model}
