"""Class-based SMT presolve_3 solver (Z3) similar to presolve_2 with tweaks."""
...
class SMTPresolve3NativeSolver(SMTBaseSolver):
    ...
    def get_metadata(cls) -> SolverMetadata:
        return SolverMetadata(
            ...
            description="SMT presolve_3 with period constraints (Z3)",
        )
