...
def _sequential_at_most_k(solver, literals, k, prefix=""):
    ...
    # Variables s_i_j: sum(literals[0...i]) >= j
    # i in 0..n-1, j in 1..k (using index j for count j)
    # Range k+1 allows indexing up to k
...
class SATPairwiseDTSolver(SATBaseSolver):
